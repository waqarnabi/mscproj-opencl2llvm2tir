...
__kernel void kernelCompute ( 
                        ...
                        ,read_only  pipe int ch02
                        ,write_only pipe int ch1
                            ) {

  //locals
  int dataIn0, dataIn1, dataIn2, dataOut;
  int i; 
  ...
  //for(i=0; i < SIZE; i++) {
    ...
    read_pipe(ch02, &dataIn2);
    #ifdef DEBUG    
      printf("DEV::kernelCompute: i = %d, read from ch0 = %d :: ch1 = %d\n", i, dataIn0, dataIn1);
    #endif
    
    //the computation
    dataOut = dataIn0 + dataIn1 + dataIn2;
